...
<head>
    ...
    <link rel="stylesheet" href="css/cnxmed.css">
...
<body>
    ...
    <section>
        <img style="width:600px ; height:580px; border-radius: 1%;" class="text-center" 
        src="images/ph1.jpg" alt="picto_features_2">
            
        <div class="accueil-med" style="margin: 100px;">
            <h1>Bienvenue Docteur !</h1><br>
    ...
    <main>
        ...
        <div class="container" id="login">
            <div class="form-container login-container">
                <form action="cnxmed_post.php" method="post">
