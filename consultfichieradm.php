...
<body>
    ...
    <h1 style="padding-left: 35%;">Liste des patients</h1>
    <form method="POST" action="rechercher_patadm.php">
...
<div class="container">
    <table>
        <tr>
            ...
            <th scope="col">Personne à contacter en cas d'urgence</th>
            <th scope="col">Numero à contacter en cas d'urgence</th>
            <th scope="col">Relation avec la personne à contacter en cas d'urgence</th>
