...
<body>
    ...
    <form method="POST" action="rechercher_patinf.php">
...
<div class="container">
    <table>
        ...
        <?php 
         ...
         echo '<td><a href="compte_patinf.php?id='.$data['id'].'">Voir le compte</a></td>';
                    echo '<td><a href="fiche_patinf.php?id='.$data['id'].'">Voir la fiche</a></td>';
         echo'</tr>';
        }
       ?>
    </table>
